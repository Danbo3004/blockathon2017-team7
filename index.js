...
const web3 = new Web3(
  new Web3.providers.HttpProvider("http://www.blockathon.asia:8545/")
);
...
const userAccPk =
  "52f13c2fe2f99e53588eed126380d2e84d02ef867b0b0fce2df40a9de2a534b7";
// acc btc
const btcAcc = "0x5ad558987acfdba1f3e0f7aa4790fe264353b451";

const refereeAcc = "0xAbC7Ce327EEac6D5CF989cE8b21213Db91d56bc9";

const bookingListContract = web3.eth
  .contract(JSON.parse(bookingContractAbi))
  .at(bookingContractAddr);
...
app.get("/addNewBooking", (req, res) => {
  ...
  bookingListContract.addNewBooking(
    "BookingInfo",
    { from: btcAcc, gas: 500000 },
    (error, info) => {
...
app.post("/addReview", (req, res) => {
  ...
  // call to addReview
  bookingListContract.addNewReview(
    req.body.roomId,
    req.body.rate,
    req.body.comment,
    { from: userAcc, gas: 500000 },
    (error, info) => {
      console.log("Info: ", info);
    }
  );
